      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <p>
              By accessing and using The Pitch Deck platform ("Service"), you accept and agree to be bound by the terms
            ...
            <p>
              The Pitch Deck is a platform that connects high school students with business case competitions. We
              provide tools for discovering competitions, submitting applications, and hosting events. The service is
            ...
            <ul>
              ...
              <li>You must comply with specific competition rules and deadlines</li>
              <li>Prize distribution is subject to verification of eligibility</li>
              <li>We reserve the right to disqualify participants for rule violations</li>
            </ul>

            <h2>6. Intellectual Property</h2>
            <p>
              The Service and its original content, features, and functionality are owned by The Pitch Deck and are
              protected by international copyright, trademark, patent, trade secret, and other intellectual property
              laws.
            </p>
            <p>
              By submitting content to competitions, you grant us a non-exclusive license to use, display, and
              distribute your submissions for promotional and educational purposes.
            </p>
            ...
            <h2>8. Disclaimers</h2>
            <p>
              The information on this platform is provided on an "as is" basis. We disclaim all warranties, express or
            ...
            <p>
              In no event shall The Pitch Deck be liable for any indirect, incidental, special, consequential, or
