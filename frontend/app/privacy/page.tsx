      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert">
            ...
            <p>
              This may include your name, email address, school information, grade level, and other details necessary
            ...
            <p>
              When you apply to competitions, we share necessary information with organizers to process your application
              and facilitate participation.
            </p>

            <h3>With Service Providers</h3>
            <p>
              We work with third-party service providers who help us operate our platform, such as hosting services,
              email providers, and analytics tools.
            </p>
            ...
            <p>
              ...
              purposes outlined in this policy. We may retain certain information for longer periods as required by law
            ...
            <p>
              Our Service is designed for high school students (ages 13-18). We comply with applicable laws regarding
              the collection of information from minors. If you are under 18, please ensure you have parental consent
              before using our Service.
            </p>

            <h2>10. International Users</h2>
            <p>
              If you are accessing our Service from outside the United States, please be aware that your information may
