    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Celebrating Our Champions</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Meet the talented students who have excelled in case competitions and made their mark in the business world.
          </p>
        </div>
          ...
          {pastWinners.map((winner) => (
            <Card key={winner.id} className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="font-semibold text-lg text-gray-900 mb-2">{winner.name}</h3>
                <p className="text-sm text-gray-600 mb-2">{winner.school}</p>
                <p className="text-sm font-medium text-primary mb-3">{winner.competition}</p>
